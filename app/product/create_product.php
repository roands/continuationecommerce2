...
if($_SERVER["REQUEST_METHOD"] == "POST"){
 ...
 // Define the processImage function outside the POST request handling
...
try{
     ...
     unit_price, total_price, created_at, updated_at) values (:p_product_name, :p_product_description, 
     :p_category_id, :p_base_price, :p_stocks, :p_unit_price, :p_total_price, NOW(), NOW())";
     $stmt = $conn->prepare($sql);
