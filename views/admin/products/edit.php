                ...
                <div class="col-md-8">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control" id="numberOfStocks" name="numberOfStocks" placeholder="Enter stocks" value="<?php echo $product["stocks"] ?>"oninput="calculateTotalPrice()">
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="totalPrice" name="totalPrice" placeholder="Total Price" value="<?php echo $product["total_price"] ?>">
                        </div>
                    </div>
